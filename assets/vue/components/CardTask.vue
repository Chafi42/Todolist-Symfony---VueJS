    ...
    <div class="mt-6 w-full relative top-50">
        ...
        <div class="mt-4 container mx-auto overflow-x-auto">
            ...
            >
                <thead>
                    <tr>
                        <th class="border-b-1 px-2 sm:px-4 py-2">ID</th>
                        <th class="border-b-1 px-2 sm:px-4 py-2">Auteur</th>
                        <th class="border-b-1 px-2 sm:px-4 py-2">Description</th>
                        <th class="border-b-1 px-2 sm:px-4 py-2">Statut</th>
                        <th class="border-b-1 px-2 sm:px-4 py-2">Actions</th>
                    </tr>
                </thead>
                <tbody>
                    <tr v-if="loading">
                    ...
                    >
                        <td class="border-b-1 px-2 sm:px-4 py-2">{{ task.id }}</td>
                        <td class="border-b-1 px-2 sm:px-4 py-2 break-words">
                            {{ task.title }}
                        </td>
                        <td class="border-b-1 px-2 sm:px-4 py-2 break-words">
                            {{ task.description }}
                        </td>
                        <td class="border-b-1 px-2 sm:px-4 py-2">
                            {{ task.status }}
                        </td>
                        <td class="border-b-1  py-6 flex break-words justify-center items-center">
                            <ShowTask :task="task" />
                            <UpdatedTask
                                :task="task"
                                @updated="updateTaskInList"
                            />
